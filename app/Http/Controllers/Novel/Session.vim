...
silent only
cd ~/development/college/novelite/routes
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 ~/development/college/novelite/app/Http/Controllers/Novel/NovelController.php
argglobal
silent! argdel *
$argadd .
edit ~/development/college/novelite/app/Http/Controllers/Novel/NovelController.php
...
lcd ~/development/college/novelite/routes
wincmd w
argglobal
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 72 - ((54 * winheight(0) + 31) / 63)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
72
normal! 0
lcd ~/development/college/novelite/app/Http/Controllers/Novel
wincmd w
2wincmd w
exe 'vert 1resize ' . ((&columns * 31 + 86) / 173)
exe 'vert 2resize ' . ((&columns * 141 + 86) / 173)
